    ...
    public class BezierPatchRenderer: Common.RendererBase
    {
        ...
        protected override void CreateDeviceDependentResources()
        {
            ...
            vertexBuffer = ToDispose(Buffer.Create(device, BindFlags.VertexBuffer, new[] {
                ...
                // Approx. Parabola
                //new Vertex(-1, 0, 1,       0, 0),
                //new Vertex(-0.34f, 2, 1,   1, 0),
                //new Vertex(0.34f, 2, 1, 2, 0),
                //new Vertex(1, 0, 1,        3, 0),
                
                //new Vertex(-1, 2, 0.34f,       0, 1),
                //new Vertex(-0.34f, 4, 0.34f,   1, 1),
                //new Vertex(0.34f, 4, 0.34f, 2, 1),
                //new Vertex(1, 2, 0.34f,     3, 1),

                //new Vertex(-1, 2, -0.34f,     0, 2),
                //new Vertex(-0.34f, 4, -0.34f, 1, 2),
                //new Vertex(0.34f, 4, -0.34f,  2, 2),
                //new Vertex(1, 2, -0.34f,      3, 2),

                //new Vertex(-1, 0, -1,     0, 3),
                //new Vertex(-0.34f, 2, -1, 1, 3),
                //new Vertex(0.34f, 2, -1,  2, 3),
                //new Vertex(1, 0, -1,      3, 3),
            }));
